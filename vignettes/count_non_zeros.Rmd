...
And you might be interested in getting a grand summary of a dataframe, on every column of the data-frame. This creates a named vector, such that each column reports the number of non-zero values in the column.

```{r}
df_nums <- data.frame('Name'=c("John", "Sarah", "Jeff", "Karen", "James"), "First_Aid_Training"=c(0,1,1,0,1))
countNonZero(df_nums$First_Aid_Training)
```
